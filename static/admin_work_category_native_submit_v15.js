(() => {
  ...
  const submitNative = (operation, payload = {}) => {
    ...
    form.method = 'post';
    // Use the exact admin URL that is already open and working in this browser.
    // This mirrors the existing employee/role forms and avoids every custom POST path.
  ...
  window.__MEDPARK_ADMIN_WORK_CATEGORY_TRANSPORT__ = 'v15-existing-admin-view';
})();
