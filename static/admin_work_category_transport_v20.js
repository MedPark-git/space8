(() => {
  ...
  window.fetch = function medparkAdminWorkCategoryV20Fetch(input, init = {}) {
    ...
    if (body instanceof FormData) {
      ...
      body.set('awc_source', 'v20-v2-direct-admin');
    }
  ...
  window.__MEDPARK_ADMIN_WORK_CATEGORY_TRANSPORT__ = 'v20-v2-direct-admin';
})();
