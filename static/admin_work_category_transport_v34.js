(() => {
  ...
  const TARGET = '/admin?section=work-categories&awc_admin=v34';

  const csrfToken = () => document.querySelector('meta[name="csrf-token"]')?.content || '';

  window.fetch = function medparkAdminWorkCategoryV34(input, init = {}) {
    ...
    encoded.set('awc_source', 'v34-header');
    ...
    headers.set('X-MedPark-Admin-Category', 'v34');
  ...
  window.__MEDPARK_ADMIN_WORK_CATEGORY_TRANSPORT__ = 'v34-header';
})();
