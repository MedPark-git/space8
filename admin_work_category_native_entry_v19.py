...
# Export the real Flask app. Administrator work-category CRUD now uses the
# dedicated v19 API path. V44 stays loaded only as a legacy fallback for stale
# clients that still post to /tasks/new.
app = guard.flask_app
