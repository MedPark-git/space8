...
# Use one request layer only: the existing first Flask before_request hook.
# It performs the normal CSRF check and dispatches to the proven category CRUD
# handlers before the ordinary task-registration validator can run.
